  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-50 p-6">
      ...
      <div className="space-x-4">
        <button onClick={() => { setIsSignup(false); openModal(); }} className="bg-blue-500 text-white px-4 py-2 rounded">
          Login Patient
        </button>
        <button onClick={() => { setIsSignup(false); openModal(); }} className="bg-blue-500 text-white px-4 py-2 rounded">
          Login Doctor
        </button>
        <button onClick={() => { setIsSignup(true); openModal(); }} className="bg-green-500 text-white px-4 py-2 rounded">
          Sign Up
        </button>
      </div>
